...
Listado.prototype.buscarRestaurante = function(id) {
    var restauranteEncontrado = this.restaurantes.find(restaurante => restaurante.id === id);
    if (restauranteEncontrado === undefined) {
        restauranteEncontrado = "No se ha encontrado ningún restaurant";
    }
...
Listado.prototype.obtenerUbicaciones = function() {
    ...
    var ciudadesFiltradas = filtrarDatos(ciudades);
...
Listado.prototype.obtenerRubros = function() {
    ...
    var rubrosFiltrados = filtrarDatos(rubros);
...
Listado.prototype.obtenerHorarios = function() {
    ...
    var horarios = arregloDeHorarios.flat();

    //En este arreglo vamos a poner todos los horarios pero sin repetidos
    var horariosFiltrados = filtrarDatos(horarios);

    return horariosFiltrados.sort();
}


var filtrarDatos = function(arregloDeDatos) {
    var datosFiltrados = arregloDeDatos.filter(function(elem, index, self) {
